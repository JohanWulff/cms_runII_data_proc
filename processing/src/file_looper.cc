...
bool FileLooper::loop_file(const std::string& fname, const std::string& oname, const std::string& channel,
    ...
    */
    ...
    while (reader.Next()) {
        ...
        if ((b_1_csv > 0.049) ^ (b_2_csv > 0.049)) num_btag_loose = 1;
        if ((b_1_csv > 0.049) && (b_2_csv > 0.049)) num_btag_loose = 2;
        if ((b_1_csv > 0.2783) ^ (b_2_csv > 0.2783)) num_btag_medium = 1;
        if ((b_1_csv > 0.2783) && (b_2_csv > 0.2783)) num_btag_medium = 2;
...
std::string FileLooper::_get_region(std::string region, std::string channel, int isOS, float dau1_deepTauVsJet, float dau2_deepTauVsJet, float dau1_iso, float dau1_eleMVAiso ){
    if (channel == "tauTau"){
        if (isOS != 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 5) region = "SR"; // signal region: opposite sign, isolated taus
        else if (isOS == 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 5) region = "SStight"; // B region
        else if (isOS != 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 1) region = "OSrlx";
        else if (isOS == 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 1) region = "SSrlx"; // # B' region
        else if (isOS != 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "OSinviso"; //  # C region
        else if (isOS == 0 && dau1_deepTauVsJet >= 5 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "SSinviso"; //  # D region
        else region = "";
    }
    else if (channel == "muTau"){
        if (isOS != 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 5) region = "SR"; // signal region: opposite sign, isolated taus
        else if (isOS == 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 5) region = "SStight"; // B region
        else if (isOS != 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 1) region = "OSrlx";
        else if (isOS == 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 1) region = "SSrlx"; // # B' region
        else if (isOS != 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "OSinviso"; //  # C region
        else if (isOS == 0 && dau1_iso < 0.15 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "SSinviso"; //  # D region
        else region = "";
    }
    else if (channel == "eTau"){
        if (isOS != 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 5) region = "SR"; // signal region: opposite sign, isolated taus
        else if (isOS == 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 5) region = "SStight"; // B region
        else if (isOS != 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 1) region = "OSrlx";
        else if (isOS == 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 1) region = "SSrlx"; // # B' region
        else if (isOS != 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "OSinviso"; //  # C region
        else if (isOS == 0 && dau1_eleMVAiso == 1 && dau2_deepTauVsJet >= 1 && dau2_deepTauVsJet < 5) region = "SSinviso"; //  # D region
        else region = "";
    }
    return region;
}
...
int FileLooper::_region_lookup(const std::string& region) {
    ...
    if (region == "OSinviso")  return 1;
    if (region == "SStight")      return 2;
    if (region == "SSinviso")  return 3;
    if (region == "SSrlx") return 4;
    if (region == "OSrlx") return 5;
...
void FileLooper::_sample_lookup(std::string& sample, int& sample_id, Spin& spin, float& res_mass) {
    ...
    if (sample.find("_ggF_") != std::string::npos) { 
        ...
        sample_id = 0;
    } else if (sample.find("_TT") != std::string::npos) {
        sample_id = 1;
